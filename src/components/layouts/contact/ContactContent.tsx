        ...
        <section className="pt-20 pb-24 md:pt-24 md:pb-32 bg-bg relative z-10 overflow-hidden">
            ...
            <div className="container-section max-w-6xl relative">
                <div className="mb-20 text-center animate-fade-in">
                    <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-color-border bg-card/50 text-primary-300 text-sm font-semibold mb-8 animate-fade-in-up">
                ...
                <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-2 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                        <div className="space-y-6">
                            ...
                            <div className="relative p-8 rounded-3xl border border-color-border bg-card overflow-hidden">
                                    ...
                                    <ul className="space-y-6">
                                        <li className="group">
                                            <a href="mailto:hey@codemeapixel.dev" className="flex items-start gap-4">
                                                <div className="p-3 rounded-xl border border-color-border bg-card text-primary-300 flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="lg:col-span-3 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                        <div className="relative p-8 md:p-10 rounded-3xl border border-color-border bg-card overflow-hidden">
                            <div className="relative">
                                ...
                                {formState === 'success' ? (
                                    <div className="flex flex-col items-center text-center py-12 animate-fade-in">
                                        <div className="p-5 rounded-2xl border border-color-border bg-card text-green-400 mb-6">
                                    ...
                                    <div className="flex flex-col items-center text-center py-12 animate-fade-in">
                                        <div className="p-5 rounded-2xl border border-color-border bg-card text-red-400 mb-6">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                            ...
                                            <div>
                                                ...
                                                <div className="relative group">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full p-4 pl-12 rounded-xl border border-color-border bg-card focus:ring-2 focus:ring-primary-500/50 transition-all text-color-text placeholder:text-color-text-muted/50"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={handleChange}
                                                className="w-full p-4 rounded-xl border border-color-border bg-card focus:ring-2 focus:ring-primary-500/50 transition-all text-color-text placeholder:text-color-text-muted/50"
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                onChange={handleChange}
                                                className="w-full p-4 rounded-xl border border-color-border bg-card focus:ring-2 focus:ring-primary-500/50 transition-all text-color-text placeholder:text-color-text-muted/50 resize-y"
                                        ...
                                        <div>
                                            <button
                                                type="submit"
                                                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-primary-500 hover:bg-primary-400 text-white font-semibold transition-colors duration-150 w-full sm:w-auto justify-center"
...
function SocialButton({ icon, label, href }: SocialButtonProps) {
    return (
        <a
            ...
            className="flex items-center gap-3 px-5 py-3 rounded-xl border border-color-border bg-card hover:bg-card-alt transition-colors duration-150"
        >
